...
## Switches
 ...
 set_property PACKAGE_PIN V16 [get_ports {swap}]
 set_property IOSTANDARD LVCMOS33 [get_ports {swap}]
 set_property PACKAGE_PIN W17 [get_ports {data_in[0]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[0]}]
 set_property PACKAGE_PIN W15 [get_ports {data_in[1]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[1]}]
 set_property PACKAGE_PIN V15 [get_ports {data_in[2]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[2]}]
 set_property PACKAGE_PIN W14 [get_ports {data_in[3]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[3]}]
 set_property PACKAGE_PIN W13 [get_ports {data_in[4]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[4]}]
 set_property PACKAGE_PIN V2 [get_ports {data_in[5]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[5]}]
 set_property PACKAGE_PIN T3 [get_ports {data_in[6]}]
 set_property IOSTANDARD LVCMOS33 [get_ports {data_in[6]}]
 set_property PACKAGE_PIN T2 [get_ports {data_in[7]}]
...
## LEDs
 ...
 set_property PACKAGE_PIN V13 [get_ports {rdy}]
 set_property IOSTANDARD LVCMOS33 [get_ports {rdy}]
 set_property PACKAGE_PIN V3 [get_ports {busy}]
